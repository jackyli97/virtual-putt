...
const collideCircles = (object1, otherObject) => {
    ...
    if (otherObject instanceof GolfCourse) return distanceBtwn < radiiSum + 30;
...
export const resolveCollision = (obj1, obj2) => {
    ...
    if ((xVelocityDiff * xDist + yVelocityDiff * yDist) >= 0) {
        ...
        if (!(obj2 instanceof GolfCourse)) { // Change both ojects velocities, unless the second one is a golfcourse
